                        ...
                        <div className="row">
                            <div className="col-lg-4 col-sm-12 col-md-4">
                                <div className="box_main active">
                                    <div className="house_icon">
                                        <img src="images/icon1.png" alt='img' className="image_1" />
                                        <img src="images/icon1.png" alt='img' className="image_2" />
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12 col-md-4">
                                <div className="box_main">
                                    <div className="house_icon">
                                        <img src="images/icon2.png" alt='img' className="image_1" />
                                        <img src="images/icon2.png" alt='img' className="image_2" />
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12 col-md-4">
                                <div className="box_main">
                                    <div className="house_icon">
                                        <img src="images/icon3.png" alt='img' className="image_1" />
                                        <img src="images/icon3.png" alt='img' className="image_2" />
                                    </div>
